...
import static com.yamangulov.SumAlertsApp.STATE_STORE_NAME;

public class ProductJoiner implements ValueTransformerWithKey<String, GenericRecord, SumAlertsApp.JoinResult> {
    ...
    @Override
    public SumAlertsApp.JoinResult transform(String key, GenericRecord purchase) {
        try {
            if (key == null) {
            ...
            return new SumAlertsApp.JoinResult(true, result);
        } catch (Exception e) {
            ...
            return new SumAlertsApp.JoinResult(false, purchase);
        }
    }
